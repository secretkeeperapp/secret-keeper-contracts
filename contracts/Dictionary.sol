...
// Originally from https://github.com/sagivo/solidity-utils
...
library Dictionary {
    ...
    function get(Data storage self, uint id) internal view returns (bytes storage) {
